            ...
            <ul className="space-y-3 text-gris-suave">
              {LINEAS_INVESTIGACION.map((linea, index) => (
                <li key={index} className="flex items-start space-x-2">
                  <ChevronRight size={20} className="text-verde-vid mt-1" />
                  <span>{linea}</span>
                </li>
              ))}
            </ul>
...
//           <div className="bg-beige-calido p-8 rounded-lg">
//             <Lightbulb size={48} className="text-verde-vid mb-4" />
//             <h3 className="text-2xl font-bold text-morado-uva mb-4">Líneas de Investigación</h3>
//             <ul className="space-y-3 text-gris-suave">
//               <li className="flex items-start space-x-2">
//                 <ChevronRight size={20} className="text-verde-vid  mt-1" />
//                 <span>Desarrollo socioemocional en ambientes Montessori</span>
//               </li>
//               <li className="flex items-start space-x-2">
//                 <ChevronRight size={20} className="text-verde-vid  mt-1" />
//                 <span>Autorregulación y autonomía en el aprendizaje</span>
//               </li>
//               <li className="flex items-start space-x-2">
//                 <ChevronRight size={20} className="text-verde-vid  mt-1" />
//                 <span>Correlación entre materiales manipulativos y logro académico</span>
//               </li>
//             </ul>
//           </div>
...
//           <div className="bg-beige-calido p-8 rounded-lg">
//             <Award size={48} className="text-morado-uva mb-4" />
//             <h3 className="text-2xl font-bold text-morado-uva mb-4">Convenios Académicos</h3>
//             <p className="text-gris-suave mb-4">
//               Colaboramos con universidades para medir objetivamente el impacto académico, social y familiar de la educación Montessori.
//             </p>
//             <Button variant="outline" className="text-sm">
